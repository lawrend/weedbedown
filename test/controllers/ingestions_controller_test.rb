...
class IngestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingestion" do
    assert_difference("Ingestion.count") do
      post ingestions_url, params: { ingestion: { dateAndTime: @ingestion.dateAndTime, method: @ingestion.method, strain: @ingestion.strain, user_id: @ingestion.user_id } }
    end
  ...
  test "should update ingestion" do
    patch ingestion_url(@ingestion), params: { ingestion: { dateAndTime: @ingestion.dateAndTime, method: @ingestion.method, strain: @ingestion.strain, user_id: @ingestion.user_id } }
